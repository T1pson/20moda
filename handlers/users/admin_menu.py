...
def get_about_bot():
    ...
    message = "<b>📰 ВСЯ ИНФОРАМЦИЯ О БОТЕ</b>\n" \
              ...
              f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
              f"<b>🔶 Средства 🔶</b>\n" \
              f"📗 Продаж за 24 часа на: <code>{show_profit_day}грн</code>\n" \
              f"💰 Продано товаров на: <code>{show_profit_all}грн</code>\n" \
              f"📕 Пополнений за 24 часа: <code>{show_buy_day}грн</code>\n" \
              f"💳 Средств в системе: <code>{show_money_in_bot}грн</code>\n" \
              f"🥝 Пополнено: <code>{show_refill}грн</code>\n" \
              f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
              f"<b>🔶 Прочее 🔶</b>\n" \
